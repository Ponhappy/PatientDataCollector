...
# USER_CONFIG_DIR = Path(os.getenv("YOLO_CONFIG_DIR") or get_user_config_dir())  # Ultralytics settings dir 原来的路径
USER_CONFIG_DIR = Path(__file__).resolve().parent
SETTINGS_YAML = USER_CONFIG_DIR / "settings.yaml" # 当前脚本目录
