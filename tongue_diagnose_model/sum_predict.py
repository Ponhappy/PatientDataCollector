...
import predict.cancer_predict
import predict.coating_predict
import predict.color_predict
...
if __name__ == "__main__":
    test_image = r"F:\图像处理\img_11.png"  # 替换为实际图片路径
    color_report,coating_report,cancer_report,tongue_annotated,diagnosis,treatment=sum_predict(test_image)
